...
class ResponseEstructure
{
	...
	public function get_messages_errors()
	{
		return $this->messages["messages_errors"];
	}

	public function get_messages_success()
	{
		return $this->messages["messages_success"];
	}
	...
	public function get_response_array()
	{
		return array(
			...
			"messages_success"=>$this->get_messages_success(),
			"messages_errors"=>$this->get_messages_errors(),
			"data"=>$this->data,
		);
	}
}